...
.provider("scrollbarConfig", function() {
	var defaultConfig = {
...
.controller('scrollbarController', ["scrollbarConfig", function(scrollbarConfigService) {
	var defaultConfig = scrollbarConfigService.getDefaultConfig();
