...
function changeBoxSize() {
	var interval = setInterval(function(){
		if($(".timeBody").length > 0 ) {
			...
			dateBody.css("transition","top 1s");
...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			'<a class="ui-datepicker-prev ui-corner-all" onClick="changeBoxSize()" data-handler="prev" data-event="click"' +
		...
		var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			'<a class="ui-datepicker-next ui-corner-all" onClick="changeBoxSize()" data-handler="next" data-event="click"' +
				...
				for (var dRow = 0; dRow < numRows; dRow++) { // create date picker rows
					...
					for (var dow = 0; dow < 7; dow++) { // create date picker days
						...
						tbody += '<td class="' +
							...
							(unselectable ? '<span class="ui-state-default">' + printDate.getDate() + '</span>' : '<a onClick="chooseDate(this)" class="ui-state-default' +
		...
		//TODO @by wwx427379, implement timepicker.
