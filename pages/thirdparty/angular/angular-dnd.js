...
(function() {
    ...
    function Mouse(dnd) {
        this.clickPoint = {x: 0, y: 0}; //@by wangjh, fix bug of ng-click not work when mouse down sometimes.
    	this.dnd = dnd;
    ...
    Mouse.prototype = {
        ...
        mousedown: function (event) {
            ...
            this.clickPoint = {x: event.screenX, y: event.screenY};
        ...
        mousemove: function(event) {
            ...
            if(Math.abs(x - this.clickPoint.x) > 0 || Math.abs(y - this.clickPoint.y) > 0) {
